        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LBP = table.Column<int>(type: "int", nullable: false),
                    Hemoglobin = table.Column<int>(type: "int", nullable: false),
                    HBA1CFBS = table.Column<int>(name: "HBA1C_FBS", type: "int", nullable: false),
                    Cholesterol = table.Column<int>(type: "int", nullable: false),
                    Creatinine = table.Column<int>(type: "int", nullable: false),
                    SGPT = table.Column<int>(type: "int", nullable: false),
                    ECGTMT = table.Column<string>(name: "ECG_TMT", type: "nvarchar(max)", nullable: false),
                    MER = table.Column<string>(type: "nvarchar(max)", nullable: false),
